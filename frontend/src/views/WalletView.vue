      ...
      <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex items-center space-x-2">
          <button
            ...
            :class="sortHoldingsBy === 'value' ? 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900 dark:text-indigo-300' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'"
          >
            Value
          </button>
          <button
            ...
            class="px-3 py-1 rounded-md text-sm font-medium"
            :class="sortHoldingsBy === 'amount' ? 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900 dark:text-indigo-300' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'"
          >
            Amount
          </button>
        </div>
      ...
      <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex items-center space-x-2">
          <button
            ...
            class="px-3 py-1 rounded-md text-sm font-medium"
            :class="selectedFilter === filter.value ? 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900 dark:text-indigo-300' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'"
          >
            {{ filter.label }}
          </button>
        </div>
