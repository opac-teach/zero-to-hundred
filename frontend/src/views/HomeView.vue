    ...
    <div class="py-24 bg-white dark:bg-gray-800">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">About Zero to Hundred</h2>
          <p class="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Revolutionizing the memecoin ecosystem with innovative trading mechanics and a vibrant community.
          </p>
        </div>
            ...
            <div class="space-y-12">
              <div class="relative">
                <div class="flex items-center">
                  ...
                  <div class="ml-4">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white">Create an Account</h3>
                    <p class="mt-2 text-base text-gray-500 dark:text-gray-400">
              ...
              <div class="relative">
                <div class="flex items-center">
                  ...
                  <div class="ml-4">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white">Create or Trade Memecoins</h3>
                    <p class="mt-2 text-base text-gray-500 dark:text-gray-400">
              ...
              <div class="relative">
                <div class="flex items-center">
                  ...
                  <div class="ml-4">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white">Earn and Compete</h3>
                    <p class="mt-2 text-base text-gray-500 dark:text-gray-400">
